...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        const response = await fetch(((window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1') ? 'http://localhost:5000' : 'https://mockly-backend-fk2i.onrender.com') + '/api/papers?isFree=true');
